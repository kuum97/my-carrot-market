      ...
      <div className="py-16 px-4 space-y-8">
        {[1, 2, 3, 4, 5, 6].map((_, i) => (
          <div key={i} className="flex flex-col cursor-pointer items-start">
            <span className="flex items-center px-2.5 py-0.5 rounded-full font-medium bg-gray-100 text-gray-800">
              동네질문
            </span>
        ...
        <button className="fixed hover:bg-orange-500 cursor-pointer transition-colors bottom-28 right-9 bg-orange-400 rounded-full shadow-xl text-white p-4">
          <svg
            className="w-6 h-6"
            fill="none"
            stroke="currentColor"
